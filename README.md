...
Place your pipeline image here.
...
The MentorCruise data was collected using Python Selenium to gather information about mentors, including:
...
Converts the query into a text representation

Compares it with mentor profiles

Computes similarity scores

Ranks mentors based on relevance
...
<p align="center">
  <img src="images/interface_example.png" width="850">
</p>

The interface allows users to describe the type of help they need (for example, Python mentorship).
The system then retrieves and ranks mentors based on their similarity to the query.
...
Integrating APIs from mentorship platforms
